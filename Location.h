...
// Returns the number of map locations loaded into the map array or returns -1 if
// there's an error loading the locations. If an error is returned, the program should
// terminate.
